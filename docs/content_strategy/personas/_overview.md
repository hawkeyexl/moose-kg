...
model: qualified reader — prerequisites brought, not proficiency levels
personas:
...
all. Turtle output can be *shown* — it is the product — but the reader must not have to parse
